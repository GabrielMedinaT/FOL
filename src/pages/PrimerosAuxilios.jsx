    ...
    <div>
      ...
      <div className={`transition-container ${ver && "hidden"}`}>
        ...
        <p>
          ...
          <a target="_blank" href="https://www.comunidad.madrid/hospital/summa112/ciudadanos/debe-hacer-emergencia#:~:text=Alertar%3A%20alerte%20a%20los%20Servicios,profesionales%20que%20atender%C3%A1n%20su%20llamada.">Este enlace</a>{" "}
          .
        </p>
      </div>
    </div>
